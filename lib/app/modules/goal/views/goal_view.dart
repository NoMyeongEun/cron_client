...
class GoalView extends GetView<GoalController> {
  GoalView({Key? key}) : super(key: key);
  final goal_controller = Get.put(GoalController());
          ...
          GridView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              return GestureDetector(
                onTap: () { goal_controller.toggleSelection(index);},
                child: Obx( () { 
                  return Card(
                  color: goal_controller.selectedCards.contains(index) ? Color.fromARGB(255, 251, 231, 120) : const Color.fromARGB(255, 232, 232, 232),
                  child: Container(
                    height: 200,
                    width: 200,
                    child: Center(
                      child: Text(
                        goal_controller.getCardText(index),
